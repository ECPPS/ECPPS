...
namespace
{
     ...
     bool ImmFits(const Width size, const std::int64_t v)
     {
          ...
          {
          case Width::W8:
               return v >= std::numeric_limits<std::int8_t>::min() && std::cmp_less_equal(v,
				std::numeric_limits<std::uint8_t>::max());
          case Width::W16:
               return v >= std::numeric_limits<std::int16_t>::min() && std::cmp_less_equal(v,
          ...
          case Width::W64:
               return v >= std::numeric_limits<std::int32_t>::min() && std::cmp_less_equal(v,
